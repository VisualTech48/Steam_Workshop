...
public class SteamUGCTest : MonoBehaviour {
	public static UGCQueryHandle_t m_UGCQueryHandle;
	public static PublishedFileId_t m_PublishedFileId;
	public static UGCUpdateHandle_t m_UGCUpdateHandle;

	protected Callback<ItemInstalled_t> m_ItemInstalled;
	protected Callback<DownloadItemResult_t> m_DownloadItemResult;

	public static CallResult<SteamUGCQueryCompleted_t> OnSteamUGCQueryCompletedCallResult;
	public static CallResult<SteamUGCRequestUGCDetailsResult_t> OnSteamUGCRequestUGCDetailsResultCallResult;
	public static CallResult<CreateItemResult_t> OnCreateItemResultCallResult;
	public static CallResult<SubmitItemUpdateResult_t> OnSubmitItemUpdateResultCallResult;
	public static CallResult<UserFavoriteItemsListChanged_t> OnUserFavoriteItemsListChangedCallResult;
	public static CallResult<SetUserItemVoteResult_t> OnSetUserItemVoteResultCallResult;
	public static CallResult<GetUserItemVoteResult_t> OnGetUserItemVoteResultCallResult;

	public static CallResult<RemoteStorageSubscribePublishedFileResult_t> OnRemoteStorageSubscribePublishedFileResultCallResult;
	public static CallResult<RemoteStorageUnsubscribePublishedFileResult_t> OnRemoteStorageUnsubscribePublishedFileResultCallResult;
	...
	public void RenderOnGUI () {
		...
		GUILayout.Label ("ihfgh0813hf021h08312hrf890f38h21091111180h38031f");
		GUILayout.Label("Variables:");
		GUILayout.Label("m_UGCQueryHandle: " + m_UGCQueryHandle);
		GUILayout.Label("m_PublishedFileId: " + m_PublishedFileId);
		//Debug.LogError ("ID OF APP:" + m_PublishedFileId);
	...
	static public void CreateItem(){
		...
		//
		bool ret1 = SteamUGC.SetItemTitle(m_UGCUpdateHandle, "This is a Test");
		print("SteamUGC.SetItemTitle(" + m_UGCUpdateHandle + ", \"This is a Test\") : " + ret1);
		//
		bool ret2 = SteamUGC.SetItemDescription(m_UGCUpdateHandle, "This is the test description.");
		print("SteamUGC.SetItemDescription(" + m_UGCUpdateHandle + ", \"This is the test description.\") : " + ret2);
		//
		bool ret3 = SteamUGC.SetItemUpdateLanguage(m_UGCUpdateHandle, "english");
		print("SteamUGC.SetItemUpdateLanguage(" + m_UGCUpdateHandle + ", \"english\") : " + ret3);
		//
		bool ret4 = SteamUGC.SetItemMetadata(m_UGCUpdateHandle, "This is the test metadata.");
		print("SteamUGC.SetItemMetadata(" + m_UGCUpdateHandle + ", \"This is the test metadata.\") : " + ret4);
		//
		bool ret5 = SteamUGC.SetItemVisibility(m_UGCUpdateHandle, ERemoteStoragePublishedFileVisibility.k_ERemoteStoragePublishedFileVisibilityPrivate);
		print("SteamUGC.SetItemVisibility(" + m_UGCUpdateHandle + ", ERemoteStoragePublishedFileVisibility.k_ERemoteStoragePublishedFileVisibilityPrivate) : " + ret5);
		//
		bool ret6 = SteamUGC.SetItemTags(m_UGCUpdateHandle, new string[] {"Skin"});
		print("SteamUGC.SetItemTags(" + m_UGCUpdateHandle + ", new string[] {\"Skin\"}) : " + ret6);
		//
		bool ret7 = SteamUGC.AddItemKeyValueTag(m_UGCUpdateHandle, "TestKey", "TestValue");
		print("SteamUGC.AddItemKeyValueTag(" + m_UGCUpdateHandle + "\"TestKey\", \"TestValue\") : " + ret7);
		//
		bool ret8 = SteamUGC.SetItemContent(m_UGCUpdateHandle, Application.dataPath + "/FileZip"); // Should point to a folder containing the UGC Item
		Debug.LogError ("APPDATA == " + Application.dataPath + "/FileZip");
		print("SteamUGC.SetItemContent(" + m_UGCUpdateHandle + ", Application.dataPath + \"/FileZip\") : " + ret8);
		//
		bool ret9 = SteamUGC.SetItemPreview(m_UGCUpdateHandle, Application.dataPath + "/header.png"); // Should actually be a PNG/JPG Screenshot.
		Debug.LogError ("APPDATA == " + Application.dataPath + "/header.png");
		print("SteamUGC.SetItemPreview(" + m_UGCUpdateHandle + ", Application.dataPath + \"/header.png\") : " + ret9);
		//
		SubmitItem ();
	}
	static public void SubmitItem(){
		SteamAPICall_t handle = SteamUGC.SubmitItemUpdate(m_UGCUpdateHandle, "Test Changenote");
		OnSubmitItemUpdateResultCallResult.Set(handle);
		print("SteamUGC.SubmitItemUpdate(" + m_UGCUpdateHandle + ", \"Test Changenote\") : " + handle);
	}
